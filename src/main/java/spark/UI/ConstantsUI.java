...
public class ConstantsUI {
     ...
     * 软件名称,版本
     */
    public final static String APP_NAME = "SparkPOI";
    ...
    public final static Image IMAGE_ICON = Toolkit.getDefaultToolkit()
            .getImage(MainAppUI.class.getResource("/icon/WeSync.png"));
     ...
     */
    // 标题字体
    public final static Font FONT_TITLE = new Font("标题", 0, 27);
    // 普通字体
    public final static Font FONT_NORMAL = new Font("标题", 0, 13);
    // radio字体
    public final static Font FONT_RADIO = new Font("标题", 0, 15);

    /**
     * 主图标
     */
    public final static ImageIcon ICON_DATA_SYNC = new ImageIcon(
            MainAppUI.class.getResource("/icon/WeSync.png"));
    /**
     * 工具栏图标
     */
    // 状态 默认
    public final static ImageIcon ICON_STATUS = new ImageIcon(
            MainAppUI.class.getResource("/icon/status.png"));
    // 状态 激活
    public final static ImageIcon ICON_STATUS_ENABLE = new ImageIcon(
            MainAppUI.class.getResource("/icon/statusEnable.png"));
    // 数据库 默认
    public final static ImageIcon ICON_DATABASE = new ImageIcon(
            MainAppUI.class.getResource("/icon/database.png"));
    // 数据库 激活
    public final static ImageIcon ICON_DATABASE_ENABLE = new ImageIcon(
            MainAppUI.class.getResource("/icon/databaseEnable.png"));
    // 执行计划 默认
    public final static ImageIcon ICON_SCHEDULE = new ImageIcon(
            MainAppUI.class.getResource("/icon/schedule.png"));
    // 执行计划 激活
    public final static ImageIcon ICON_SCHEDULE_ENABLE = new ImageIcon(
            MainAppUI.class.getResource("/icon/scheduleEnable.png"));
    // 设置 默认
    public final static ImageIcon ICON_SETTING = new ImageIcon(
            MainAppUI.class.getResource("/icon/setting.png"));
    // 设置 激活
    public final static ImageIcon ICON_SETTING_ENABLE = new ImageIcon(
            MainAppUI.class.getResource("/icon/settingEnable.png"));
    // 备份 默认
    public final static ImageIcon ICON_BACKUP = new ImageIcon(
            MainAppUI.class.getResource("/icon/backup.png"));
    // 备份 激活
    public final static ImageIcon ICON_BACKUP_ENABLE = new ImageIcon(
            MainAppUI.class.getResource("/icon/backupEnable.png"));
